  ...
  return (
    <div className="h-[100%] w-[100%] flex flex-col justify-center items-center">
      <div className="relative">
        ...
        <img
          alt="advertisment"
          className="h-10 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"
          src={logo}
        ></img>
      </div>
      <div className="text-3xl font-semibold max-[1250px]:text-2xl font-Roboto tracking-normal">
        Download ChatBox for Windows
      </div>
      <div className="w-[50%] mt-4 text-center text-[#8696A0] font-Poppins text-sm">
        Experience lightning-fast messaging on your Windows device with our app.
      </div>
