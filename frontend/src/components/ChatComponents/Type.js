  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="searchbox bg-gray-100 resize-none font-Roboto box-border max-[1024px]:px-8 px-[6%] flex text-md max-[900px]:text-sm w-[95%] py-[1%] outline-none h-[70%] rounded-3xl"
      />
    </div>
  );
}
